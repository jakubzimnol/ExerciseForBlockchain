...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::Users, id_mysql, A >::email_type_
  query_columns< ::Users, id_mysql, A >::
  email (A::table_name, "`email`", 0);

  template <typename A>
  const typename query_columns< ::Users, id_mysql, A >::nickname_type_
  query_columns< ::Users, id_mysql, A >::
  ...
  template <typename A>
  const typename query_columns< ::Users, id_mysql, A >::isActive_type_
  query_columns< ::Users, id_mysql, A >::
